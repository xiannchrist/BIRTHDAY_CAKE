...
def write_text_inside_circle():
 
    my_turtle_cursor.penup()
    my_turtle_cursor.goto(0, y_coordinate + 180)
    my_turtle_cursor.pendown()
    my_turtle_cursor.color("black")
    my_turtle_cursor.setheading(270)
    my_turtle_cursor.forward(20)
    
    my_turtle_cursor.penup()
    my_turtle_cursor.goto(0, y_coordinate + 240) 
    my_turtle_cursor.color("#000000") 
    my_turtle_cursor.write("HAPPY", font=("Arial", 20, "bold"), align="center")
    
    my_turtle_cursor.goto(0, y_coordinate + 210)  
    my_turtle_cursor.write("BIRTHDAY", font=("Arial", 20, "bold"), align="center")
    
    my_turtle_cursor.goto(0, y_coordinate + 180)  
    my_turtle_cursor.write("Princess Ashley", font=("Arial", 14, "normal"), align="center")
    

    my_turtle_cursor.penup()
  
    my_turtle_cursor.goto(0, y_coordinate + 280)
    my_turtle_cursor.write("🎂", font=("Arial", 30), align="center")
